"""Command-line entry point for the DecodeClassify ETL pipeline."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Titanic raw-to-processed ETL")
    parser.add_argument("--input", type=Path, default=PROJECT_ROOT / "data/raw/titanic_raw.csv")
    parser.add_argument("--output", type=Path, default=PROJECT_ROOT / "data/processed/titanic_processed.csv")
    ...
    try:
        ...
        report = write_report("rejected", source, output, {"error": str(error)})
